# extended tests from https://github.com/sandimetz/99bottles_ruby/blob/main/lib/bottles.rb
gem "minitest", "~> 5.4"
require "minitest/autorun"
require "minitest/pride"
require_relative "./bottles"
require_relative "../../lib/seal_detective/decorator"
# require_relative "../../lib/seal_detective/messages"

CountdownSong.include(SealDetective::Decorator)
BottleVerse.include(SealDetective::Decorator)
BottleNumber.include(SealDetective::Decorator)
BottleNumber0.include(SealDetective::Decorator)
BottleNumber1.include(SealDetective::Decorator)
BottleNumber6.include(SealDetective::Decorator)
...
class CountdownSongTest < Minitest::Test
  ...
  def seal_results
    SealDetective::Messages.instance.array
  end
end
